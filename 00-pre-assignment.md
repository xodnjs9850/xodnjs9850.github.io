...
### 3-1. 2단계 인증 활성화 (필수 선행)

[네이버 메인](https://www.naver.com) → 우측 상단 본인 프로필 → **내 정보** → **보안 설정** → **2단계 인증 ON**.

> **2단계 인증이 OFF면 3-3의 애플리케이션 비밀번호 발급 페이지 자체가 막힙니다.** 반드시 먼저 활성화하세요.
{: .important }
...
앱 비밀번호는 IMAP/SMTP 등 외부 앱 접속용 12자리 전용 비밀번호입니다. 일반 비밀번호는 IMAP 접속에 사용할 수 없습니다 (2025년 정책 변경).
